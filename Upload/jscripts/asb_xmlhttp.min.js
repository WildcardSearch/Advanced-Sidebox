...
SideboxUpdater=Class.create(Ajax.Base,{initialize:initialize,start:start,stop:stop,updateComplete:updateComplete,onTimerEvent:onTimerEvent,});function buildUpdaters(updaters,widths){if(updaters.length==0){return;}
...
new SideboxUpdater(this_id,'xmlhttp.php',{parameters:{action:'asb',id:updaters[i].id,addon:updaters[i].addon,dateline:updaters[i].dateline,width:width},method:'get',frequency:updaters[i].rate});}}
