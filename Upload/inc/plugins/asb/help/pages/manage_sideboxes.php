...
$help_content = <<<EOF
		<div class="help_content">
			...
			<p>Managing side boxes is much easier with this plug-in, but there are a lot of options involved so it can get complicated. We are working to simplify the interface while maintaining (and even increasing) the current level of performance.</p>
