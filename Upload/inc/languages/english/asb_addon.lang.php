...
// wol
$l['asb_wol'] = "Who's On-line";
$l['asb_wol_desc'] = "Currently on-line members' avatars";
...
$l['asb_wol_online_users'] = "There are currently <b>{1}</b> on-line users.";
$l['asb_wol_online_user'] = "There is currently 1 user on-line";
$l['asb_wol_online_counts'] = "<b>{1}</b> Member(s) | <b>{2}</b> Guest(s)";

$l['asb_wol_no_one_online'] = "There are currently no members on-line.";
$l['asb_wol_avatar'] = "Avatar";
$l['asb_wol_avatar_lc'] = "avatar";
$l['asb_wol_see_all_alt'] = 'See all...';
$l['asb_wol_see_all_title'] = 'Click to see all on-line members.';
...
// staff on-line
$l['asb_staff_online'] = "On-line Staff";
$l['asb_staff_online_desc'] = "Display on-line staff members list";
...
$l['asb_staff_online_no_staff_online'] = "There are no staff members currently on-line.";
