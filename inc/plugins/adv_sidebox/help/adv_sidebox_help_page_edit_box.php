...
$see_also = adv_sidebox_help_build_page_link('sideboxes', 'See also:');
		...
		<div class="help_content">
			...
			<p>
				<ul>
					...
					<li><strong>Which Scripts</strong> - select from the four possible scripts: index.php, forumdisplay.php, showthread.php and portal.php</li><br />
